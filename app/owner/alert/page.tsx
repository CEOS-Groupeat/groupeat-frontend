...
import ReadyStatusModal from '../orders/summary/_components/ReadyStatusModal';
...
export default function CustomerAlertPage() {
  ...
  return (
    <div className="flex w-full min-h-screen items-center flex-col bg-background-default">
