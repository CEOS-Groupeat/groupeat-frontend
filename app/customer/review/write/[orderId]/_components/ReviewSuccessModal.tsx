...
export default function ReviewSuccessModal({
  ...
  return (
    <div
      ...
      aria-live="polite"
    >
      <div className="w-[327px] bg-background-default rounded-2xl shadow-[0px_24px_38px_-10px_rgba(23,23,23,0.12),0px_10px_15px_-5px_rgba(23,23,23,0.10)] flex flex-col justify-center items-center overflow-hidden">
