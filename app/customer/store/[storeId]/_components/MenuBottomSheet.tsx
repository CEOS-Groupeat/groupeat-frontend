...
export default function MenuBottomSheet({
  ...
  return (
    <div className="fixed inset-0 z-modal flex items-end justify-center bg-background-dim/40">
      ...
      <div className="relative w-full  max-w-[393px] h-109 bg-background-default rounded-t-[35px] flex flex-col overflow-hidden animate-in slide-in-from-bottom-full duration-200">
