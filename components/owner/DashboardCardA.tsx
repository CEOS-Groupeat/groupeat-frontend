...
export default function DashboardCardA({ text, icon, count }: DashboardCardAProps) {
  return (
    <div className="flex w-1/2 h-18.5 p-3 justify-between items-center border border-px border-border-subtle bg-static-white shadow-[6px_6px_54px_0_rgba(0, 0, 0, 0.05)] rounded-lg">
