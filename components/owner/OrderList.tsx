...
export default function OrderList({
  ...
  return (
    <div className="w-full flex p-3 flex-col items-start gap-2 rounded-lg border border-px border-border-subtle bg-static-white shadow-[6px_6px_54px_0_rgba(0, 0, 0, 0.05)]">
        ...
        <div className="flex flex-col items-start gap-1.5 self-stretch">
          ...
          <div className="flex justify-between items-center self-stretch">
            <div className="flex flex-col items-start">
                ...
                <p className="text-body text-text-default font-semibold">{customerName}</p>
            </div>
            <div className="flex flex-col items-end">
                <p className="text-caption1 text-text-subtlest">픽업 시간</p>
                <p className="text-body text-text-default font-semibold">{pickupTime}</p>
            </div>
          </div>
        </div>
      </div>
      <div className="flex items-center gap-5">
        ...
        <div className="flex items-center gap-1">
            ...
            <p className="text-text-default text-caption1 font-semibold">{quantity}개</p>
        </div>
      </div>
    </div>
  );
