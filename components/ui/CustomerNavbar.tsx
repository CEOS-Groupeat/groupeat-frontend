...
export default function CustomerNavbar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 z-sticky w-full flex pb-1 justify-between items-center bg-background-default shadow-[0px_-3px_12px_0px_rgba(165,179,198,0.10)]">
