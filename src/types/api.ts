...
export type PostResponse<T extends keyof paths> = 
  paths[T] extends { post: { responses: { 200: { content: { '*/*': infer R } } } } } ? R : never;

export type PatchResponse<T extends keyof paths> = 
  paths[T] extends { patch: { responses: { 200: { content: { '*/*': infer R } } } } } ? R : never;

export type DeleteResponse<T extends keyof paths> = 
  paths[T] extends { delete: { responses: { 200: { content: { '*/*': infer R } } } } } ? R : never;

export type PostRequest<T extends keyof paths> = 
